...
@Component({
  ...
  template: `
    ...
    <div class="command-bar" *ngIf="commandBarActive" [class.open]="commandBarActive">
      ...
      <div>
        <div *ngFor="let sandboxMenuItem of filteredSandboxMenuItems">
          <div class="sandbox"
               [class.selected]="selectedSandboxAndScenarioKeys.sandboxKey === sandboxMenuItem.key">
            {{sandboxMenuItem.prependText}}{{sandboxMenuItem.name}}
          </div>
          <div *ngFor="let scenarioMenuItem of sandboxMenuItem.scenarioMenuItems" class="scenarios">
            <svg class="scenario-icon" [class.selected]="isSelected(sandboxMenuItem, scenarioMenuItem)">
            ...
            <a
              ...
              [class.selected]="isSelected(sandboxMenuItem, scenarioMenuItem)">
    ...
    <section *ngIf="!selectedSandboxAndScenarioKeys.sandboxKey" class="help-message">
      <div>
        <p *ngIf="totalSandboxes > 0">The app has {{totalSandboxes}} sandboxed component{{totalSandboxes > 1 ? 's' : ''}}
          loaded.</p>
